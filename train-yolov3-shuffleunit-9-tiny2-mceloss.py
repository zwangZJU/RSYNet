...
def train(
    ...
    latest = weights + 'yolov3-shuffleunit-9-tiny2-mceloss.pt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-shuffleunit-9-tiny2.cfg', help='cfg file path')
    parser.add_argument('--data-cfg', type=str, default='cfg/face-l.data', help='coco.data file path')
