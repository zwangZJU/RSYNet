...
def train(
    ...
    latest = weights + 'yolov3-shuffleunit-9-tiny2-caltech-608-all.pt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-shuffleunit-9-tiny2-caltech-608-all.cfg', help='cfg file path')
    parser.add_argument('--data-cfg', type=str, default='cfg/caltech-all.data', help='coco.data file path')
    parser.add_argument('--multi-scale', action='store_true', help='random image sizes per batch 320 - 608')
    parser.add_argument('--img-size', type=int, default=32 * 19, help='pixels')
